...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net const_0_dout [get_bd_pins const_0/dout] [get_bd_pins rst_ps7_0_100M/aux_reset_in] [get_bd_pins rst_ps7_0_100M/mb_debug_sys_rst]
  connect_bd_net -net const_1_dout [get_bd_pins const_1/dout] [get_bd_pins rst_ps7_0_100M/dcm_locked]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
